<template>
    <div class="flex-col">
        ...
        <template v-if="!isLoading">
            <div class="flex flex-colo sm:flex-row justify-around items-center">
                <div class="flex flex-col items-center">
                    <img :src="`https://static.coincap.io/assets/icons/${asset.symbol.toLowerCase()}@2x.png`" class="w-20 h-20 mr-5" />
                    <h1 class="text-5xl">
                        {{ asset.name }}
                ...
                <div class="my sm:mt-0 flex flex-col justify-center text-center">
